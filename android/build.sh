...
cp -v ../thirdparty/TouchVG/android/TouchVG/libs/armeabi/libtouchvg.so test/libs/armeabi
cp -v ../thirdparty/DemoCmds/android/DemoCmds/libs/armeabi/libdemocmds.so test/libs/armeabi

mkdir -p vgdemo1/libs/armeabi
cp -v ../thirdparty/TouchVG/android/TouchVG/libs/armeabi/libtouchvg.so vgdemo1/libs/armeabi
